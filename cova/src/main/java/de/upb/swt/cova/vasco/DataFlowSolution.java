 ...
 * 
 * <p>
 * This simple mapping does not parametrise solutions with a context object, and is thus
...
public class DataFlowSolution<N, A> {
   ...
   * 
   * @param inValues
   *          a map of nodes to data flow values at their entry
   * @param outValues
   *          a map of nodes to data flow values at their exit
   */
