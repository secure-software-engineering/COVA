...
import reporter.HtmlReportPrinter;
...
public class SceneTransformerFactory {
  /** The Constant targetPath. */
  private static final String targetPath = System.getProperty("user.dir") + File.separator + "target" + File.separator;
    ...
    return new SceneTransformer() {
      ...
      protected void internalTransform(String phaseName, Map<String, String> options) {
        ...
        if (config.isWriteHtmlOutput() || config.isWriteJimpleOutput()) {
          ...
          String htmlOutputPath = targetPath + "htmlOutput" + File.separator + apkName;
  ...
  public SceneTransformer createAnalysisTransformerForTestCase(String className, String testMethodName,
    ...
    return new SceneTransformer() {
      ...
      protected void internalTransform(String phaseName, Map<String, String> options) {
        ...
        analysis.doAnalysis();
        reporter.setAnalysisResults(analysis, true);
        String htmlOutputPath = targetPath + "htmlOutput" + File.separator + className + File.separator + testMethodName;
