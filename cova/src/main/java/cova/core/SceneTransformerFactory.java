...
public class SceneTransformerFactory {
  ...
  private static final String outputPath =
      System.getProperty("user.dir") + File.separator + "covaOutput" + File.separator;
   ...
   *
   * @param apkName the apk name
   * @param callbacks the callbacks
   * @param sourceCodePath the source code path of the apk
   * @param configFilePath the config file path
   * @param reporter the reporter
   * @return the scene transformer
   */
  public SceneTransformer createAnalysisTransformerForAndroidApk(
      String apkName,
    ...
    return new SceneTransformer() {
      ...
      /**
       * This method applies local splitter and local name standardizer to each method body. This is
       * done before executing the analysis such that each disjoint DU-UD web is associated with a
       * single local. It is called before executing the condition analysis.
       *
      ...
      protected void internalTransform(String phaseName, Map<String, String> options) {
        ...
        analysis.doAnalysis();
        if (config.computeConstraintMap()
            || config.isWriteHtmlOutput()
   ...
   * @param reporter the reporter
   * @param sourceCodeDir the source code dir
   * @return the scene transformer
   */
  public SceneTransformer createAnalysisTransformerForTestCase(
      String className, String testMethodName, ConstraintReporter reporter, String sourceCodeDir) {
    return new SceneTransformer() {
   ...
   * @return the scene transformer
   */
  public SceneTransformer createAnalysisTransformerForJavaApp(
      String apkName, String sourceCodePath, String configFilePath, ConstraintReporter reporter) {
    return new SceneTransformer() {
