package de.upb.swt.cova.runner;

import de.upb.swt.cova.core.Aliasing;
import de.upb.swt.cova.core.SMTSolverZ3;
import de.upb.swt.cova.data.CombinedResult;
import de.upb.swt.cova.data.MetaData;
import de.upb.swt.cova.reporter.ConstraintReporter;
import de.upb.swt.cova.reporter.ResultPrinter;
import de.upb.swt.cova.setup.RunCova;
import de.upb.swt.cova.setup.RunFlowDroid;
      ...
      if (Files.getFileExtension(apkFilePath).equals("apk")) {
        if (!standalone) {
          if (!outputCSV) {
            ...
            MetaData meta = new de.upb.swt.cova.data.MetaData(apkName, size, reachableMethods, ftime, timeout, covaTime,
